...
VALUES
('Alice Johnson', '123 University St, City ville', '1234567890', 'alice.johnson@university.edu', true, 'password123', 'user', FALSE, NOW()),
('Bob Smith', '456 College Ave, Townsville', '0987654321', 'bob.smith@gmail.com', false, 'password123', 'user', FALSE, NOW()),
('Charlie Brown', '789 Campus Rd, City ville', '1122334455', 'charlie.brown@university.edu', true, 'password123', 'user', FALSE, NOW());

-- Insert data into Ads
INSERT INTO Ads (user_id, title, description, price, image, category_type, category_id, phone_number, location_lat, location_lon, is_archived, created_at)
VALUES
(1, 'Used Sofa', 'A comfortable 3-seater sofa in good condition.', 100.00, NULL, 'Furniture', true, '1234567890', 40.712776, -74.005974, FALSE, NOW()),
(2, 'Toyota Corolla 2010', 'Well-maintained Toyota Corolla, perfect for students.', 5000.00, NULL, 'Vehicles', 1, '0987654321', 35.712776, -75.005974, FALSE, NOW()),
(3, 'Apartment for Rent', 'Spacious 2-bedroom apartment with all amenities.', 1200.00, NULL, 'Accommodation', 1, '1122334455', 30.712776, -69.005974, FALSE,NOW());
