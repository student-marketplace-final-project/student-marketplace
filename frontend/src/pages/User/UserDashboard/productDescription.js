...
const ProductDescription = (props) => {
    ...
    //switch case for different category types to print the category data
    useEffect(() => {
                                        ...
                                        {categoryData && categoryData.category_type === 'Accommodation' && (
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td>Bedrroms</td>
                                                        <td>{categoryData && categoryData.category_details && categoryData.category_details.bedrooms}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Bathrooms</td>
                                                        <td>{categoryData && categoryData.category_details && categoryData.category_details.bathrooms}</td>
                                                    </tr>
                                                    <tr>
