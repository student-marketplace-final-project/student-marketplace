...
import './features.css'
import { getAdsBySearch, getProfileData } from "../../../Services/dashboardServices";
...
class UserDashboard extends Component {
  ...
  handleSearchSubmit() {
    this.startLoading()
    getAdsBySearch(this.state.search).then((response) => {
      const data = response.data;
      this.setState({ listings: data });
      this.stopLoading();      
    })
              ...
              <Col className="search-board">
                <div className="search-bar">
                  ...
                  <button
                    ...
                    onClick={(values) => this.handleSearchSubmit(values)}
                  >
                    🔍
                  </button>
